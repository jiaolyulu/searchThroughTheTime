Class(function ExitCrossButton({ callback, pulse = false }) {
    ...
    function initHTML() {
        ...
        $exitSymbol.html(ExitCrossButton.CLOSE_SYMBOL);

        $exitSymbolActive = $exitSymbolWrapper.create('exit-button-close-symbol');
        $exitSymbolActive.html(ExitCrossButton.CLOSE_SYMBOL_ACTIVE);
    ...
    function initStyles() {
        GoobCache.apply('ExitCrossButton', $this, /* scss */ `
        display: flex;
    ...
    ExitCrossButton.CLOSE_SYMBOL = ` 
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 3L19 19" stroke="#202124" stroke-width="2"/>
        <path d="M19 3L3 19" stroke="#202124" stroke-width="2"/>
     </svg>

 `;

    ExitCrossButton.CLOSE_SYMBOL_ACTIVE = ` 
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M3 3L19 19" stroke="#4285f4" stroke-width="2"/>
        <path d="M19 3L3 19" stroke="#4285f4" stroke-width="2"/>
     </svg>

 `;

    ExitCrossButton.ELIPSE = `
